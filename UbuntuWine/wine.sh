...
╚██████╔╝██████╔╝╚██████╔╝██║ ╚████║   ██║   ╚██████╔╝
 ╚═════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝   ╚═╝    ╚═════╝
          Windows-11
          Style-Ubuntu-Jammy-Wine-Gnome-Desktop-
          For-Termux-x11
          Script By AKATSUKI LWINGYI KONAN
          Thank For Use This Script
          Please Wait 25 Minutes 
"| pv -qL 600
...
proot-distro restore storage/shared/ADM//winex11.tar.xz
